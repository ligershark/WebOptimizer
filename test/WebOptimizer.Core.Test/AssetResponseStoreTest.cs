...
public class AssetResponseStoreTest
{
    ...
    public async Task RoundTrip_Success()
    {
        ...
        _ = env.Setup(e => e.ContentRootPath).Returns(Environment.CurrentDirectory);
        ...
        _ = woo
            .Setup(o => o.Configure(It.IsAny<WebOptimizerOptions>()))
    ...
    public void Should_Serialize_Deserialize_AssetResponse_With_Headers()
    {
        ...
        var arBase = new AssetResponse(body.AsByteArray(), cacheKey);
        ...
        var ar = new AssetResponseStore(logger.Object, env.Object, woo.Object).ParseJson(JsonSerializer.Serialize(arBase));
